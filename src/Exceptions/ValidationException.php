...
class ValidationException extends InvalidArgumentException implements ExceptionInterface, IteratorAggregate
{
     ...
     */
    public function __construct(ResultInterface $result, FactoryInterface $factory)
    {
        $this->result = $result;
    ...
    private function getPlaceholder()
    {
        ...
        return $this->normalize($this->result->getInput());
    }
    ...
    private function createMessage()
    {
        ...
        return preg_replace_callback(
            ...
            call_user_func($this->factory->getTranslator(), $this->getMessageTemplate())
        );
    }
    ...
    public function getIterator()
    {
        if (!$this->children instanceof SplObjectStorage) {
            $this->children = $this->factory->createExceptionTree($this->result);
        }
